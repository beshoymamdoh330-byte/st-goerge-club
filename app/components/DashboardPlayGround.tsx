...
export default function DashboardMembers() {
    ...
    return (
        <Link href="/dashboard/playGround" className="block w-full group">
            <div className={`p-6 rounded-3xl border transition-all duration-300 hover:-translate-y-1 cursor-pointer flex items-center justify-between ${
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h3 className="text-xl font-bold group-hover:text-blue-600 transition-colors">إداره وحده العاب</h3>
                        <p className="text-xs text-slate-500 dark:text-slate-400">انقر هنا لعرض قائمة كافة وحدات لالعاب</p>
                    </div>
                </div>
